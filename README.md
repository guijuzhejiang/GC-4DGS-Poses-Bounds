...
### [Project Page](https://liyw420.github.io/) | [Paper](https://arxiv.org/abs/2511.23044)
...
```shell
git clone https://github.com/liyw420/GC-4DGS
cd GC-4DGS
...
```
bash ./scripts/pre_dynerf/run_preprocess_train_eval.sh
```
